...
# -*- coding: utf-8 -*-
#
# PHP-Bottle documentation build configuration file, created by
...
htmlhelp_basename = 'PHP-Bottledoc'
...
latex_documents = [
  ('index', 'PHP-Bottle.tex', 'PHP-Bottle Documentation',
   'Nergal, Gordon', 'manual'),
]
...
man_pages = [
    ('index', 'php-bottle', 'PHP-Bottle Documentation',
     ['Nergal, Gordon'], 1)
]
...
texinfo_documents = [
  ('index', 'PHP-Bottle', 'PHP-Bottle Documentation',
   'Nergal, Gordon', 'PHP-Bottle', 'One line description of project.',
   'Miscellaneous'),
]
